    ...
    <c:param name="content">
        <c:choose>
            <c:when test="${order != null}">
                <h2><c:out value="${order.shop.name}" />様の受注メニュー</h2>
                ...
                <br /><br />
                <p><a href="#" onclick="confirmDestroy();"><button type="button">受注完了処理</button></a></p>
        ...
        <p><a href="<c:url value='/shops/receive' />">受注一覧に戻る</a></p>
    </c:param>
</c:import>